...
describe('Wallet', () => {
    ...
    describe('when the user types into the wallet input', () => {
        ...
        it('updates the local wallet balance in the `state` and converts that into a number', () => {
        ...
        describe('and the user wants to make a deposit', () => {
            ...
            it('dispatches the `deposit()`it recieves from props ', () => {
        ...
        describe('and the user wants to make a withdrawal', () => {
            ...
            it('dispatches the `withdraw()` it receives from props', () => {
